...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { movie_id: @wishlist.movie_id, name: @wishlist.name, user_id: @wishlist.user_id } }, as: :json
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { movie_id: @wishlist.movie_id, name: @wishlist.name, user_id: @wishlist.user_id } }, as: :json
    assert_response 200
  end
