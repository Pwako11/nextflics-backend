...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post recommendations_url, params: { recommendation: { movie_id: @recommendation.movie_id, name: @recommendation.name, user_id: @recommendation.user_id } }, as: :json
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { movie_id: @recommendation.movie_id, name: @recommendation.name, user_id: @recommendation.user_id } }, as: :json
    assert_response 200
  end
